...
public class bkmvti implements Serializable {
	...
	private String mvti = OgMoHelper.padText("", OgMoHelper.RIGHT, 6, " "); // Numéro de mouvement CHAR 6
	private String rgp = OgMoHelper.padText("", OgMoHelper.RIGHT, 3, " "); // Code regroupement pour édition CHAR 3
	...
	private String pie = OgMoHelper.padText("", OgMoHelper.RIGHT, 11, " "); // Numéro de pièce CHAR 11
	private String rlet = OgMoHelper.padText("", OgMoHelper.RIGHT, 8, " "); // Référence de lettrage CHAR 8
	private String des1 = OgMoHelper.padText("", OgMoHelper.RIGHT, 4, " "); // Code désaccord 1 CHAR 4
	private String des2 = OgMoHelper.padText("", OgMoHelper.RIGHT, 4, " "); // Code désaccord 2 CHAR 4
	private String des3 = OgMoHelper.padText("", OgMoHelper.RIGHT, 4, " "); // Code désaccord 3 CHAR 4
	private String des4 = OgMoHelper.padText("", OgMoHelper.RIGHT, 4, " "); // Code désaccord 4 CHAR 4
	private String des5 = OgMoHelper.padText("", OgMoHelper.RIGHT, 4, " "); // Code désaccord 5 CHAR 4
	private String utf = OgMoHelper.padText("", OgMoHelper.RIGHT, 10, " "); // Code utilisateur ayant rappelé pour forcer CHAR 10
	private String uta = OgMoHelper.padText("", OgMoHelper.RIGHT, 12, " "); // Code utilisateur ayant autorisé CHAR 12
	private Double tau = 1d; // Taux de change DECIMAL 15 - 7
	@JsonIgnore
	private Date din = new Date(); // Date d'indisponible DATE
	private String tpr = OgMoHelper.padText("", OgMoHelper.RIGHT, 12, " "); // Zone utilisée spécifiquement CHAR 12
	private Double npr = 0d; // Zone utilisée spécifiquement DECIMAL 12 - 0
	private String ncc = OgMoHelper.padText("", OgMoHelper.RIGHT, 11, " "); // Numéro de compte de rattachement CHAR 11
	...
	private String libnls = OgMoHelper.padText("", OgMoHelper.RIGHT, 30, " "); // Libellé mouvement autre langue CHAR 30
	...
	private String refana = OgMoHelper.padText("", OgMoHelper.RIGHT, 25, " "); // Référence analytique CHAR 25
	private String label = OgMoHelper.padText("ORANGE MONEY WALET2BANK/" + this.refdos, OgMoHelper.RIGHT, 25, " "); // Label du mouvement VARCHAR 0 - 25

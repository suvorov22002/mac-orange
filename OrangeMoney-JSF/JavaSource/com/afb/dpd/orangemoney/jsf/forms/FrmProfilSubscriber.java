...
public class FrmProfilSubscriber extends AbstractPortalForm{
	...
	/*
	 * (non-Javadoc)
	 * @see com.afb.dpd.orangemoney.jsf.models.AbstractPortalForm#initForm()
	 */
	@Override
	public void initForm() {
		// TODO Auto-generated method stub
		super.initForm();
		List<ProfilMarchands> plgs = OMViewHelper.appManager.filterProfilMarchands();
		itemsStatuts = new ArrayList<SelectItem>();
		itemsStatuts.add(new SelectItem(null,"Default"));
		for(ProfilMarchands s : plgs){
	...
	/*
	 * (non-Javadoc)
	 * @see com.afb.dpd.orangemoney.jsf.models.AbstractPortalForm#getTitle()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.afb.dpd.orangemoney.jsf.models.AbstractPortalForm#disposeResourcesOnClose()
	 */
	@Override
		...
		try {
			...
			for(Subscriber s : souscriptions){
				if(s.getProfilId() != null){
					ProfilMarchands pl = OMViewHelper.appDAOLocal.findByPrimaryKey(ProfilMarchands.class,Long.valueOf(s.getProfilId()),null);
					if(pl != null){
						s.setProfil(pl);
	...
	public void annulerSouscription() {
		...
		try {
			...
			// Annulation
			//**** OMViewHelper.appManager.annulerSouscription(idAnnulation);
